...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:2056',
            extent: [2100000.000000, 105000.000000, 2850000.000000, 1400000.000000],
            units: 'm'})
    })
});
...
map.getView().fit([2535286.676172, 1159162.267594, 2536543.115744, 1160118.590794], map.getSize());
